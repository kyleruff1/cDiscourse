...
const adapterCoreModule = require(`${BO}/booleanObservationMcpAdapterCore`) as {
  ...
  ADMIN_VALIDATION_MCP_REQUEST_TIMEOUT_MS: number;
...
export const EDGE_DRAINER_MCP_REQUEST_TIMEOUT_MS =
  adapterCoreModule.DRAINER_MCP_REQUEST_TIMEOUT_MS;
export const EDGE_ADMIN_VALIDATION_MCP_REQUEST_TIMEOUT_MS =
  adapterCoreModule.ADMIN_VALIDATION_MCP_REQUEST_TIMEOUT_MS;
