...
describe('OPS-MCP-OBSERVABILITY — report shape', () => {
  ...
  it('exposes exactly 19 sections (Q1, Q2a, Q2b, Q3-Q18)', () => {
    expect(SECTIONS).toHaveLength(19);
  });

  it('section ids are stable anchors q01...q18 plus q02b', () => {
  ...
  it('includes a Table of contents block with all 19 section links', () => {
    const md = stitchMarkdownReport(baseStitchArgs);
