...
| Synthetic launch-qualification (PR #429) | live-1% N=1 canary + N=8 burst | canary 7/7 first-attempt; burst 55/56 + 1 isolated DL; E 8/8 clean; all structural gates green | organic load; provider-vs-packet certainty on the 1 DL |
