...
| **modified** | `docs/core/current-status.md` | +25 lines (one new section), one line in front matter | New section "GAME-001 — Point exhaustion + timeout rules (Release 6.6 / Wave 3)" documenting status, files, tests, doctrine, operator follow-up (none). Front-matter date + roster line updated. |
