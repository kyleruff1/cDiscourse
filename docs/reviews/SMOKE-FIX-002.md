...
| 5.5 | `docs/current-status.md` carries a 3-line SMOKE-FIX-002 footnote pointing to the design | **Pass** — line 11 of `current-status.md` carries the footnote and references `docs/designs/SMOKE-FIX-002.md`. |
