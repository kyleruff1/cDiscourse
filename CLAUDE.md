...
Current stage: **Stage 4 complete** — discourse rails (C-RAIL-001–005), DB adapter layer, and submit-argument Edge Function implemented and tested. Start Stage 5 (UI — Debate Room + Argument Submission screens).
