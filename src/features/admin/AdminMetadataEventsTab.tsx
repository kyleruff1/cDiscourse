...
const styles = StyleSheet.create({
  ...
  selectorLabel: { fontSize: 11, fontWeight: '700', color: SURFACE_TOKENS.textSecondary, marginRight: 6 },
  selectorEmpty: { fontSize: 11, color: SURFACE_TOKENS.textMuted, fontStyle: 'italic', paddingVertical: 6 },
  toolbar: {
    flexDirection: 'row',
    padding: 8,
    backgroundColor: SURFACE_TOKENS.raised,
  ...
  deletedHint: { fontSize: 9, color: SURFACE_TOKENS.textMuted, fontStyle: 'italic', marginTop: 2 },
  ...
  sideBadge: { backgroundColor: STATUS.warning.bg },
  sideBadgeText: { fontSize: 10, fontWeight: '600', color: STATUS.warning.fg },
  tagBadge: { backgroundColor: STATUS.success.bg },
  tagBadgeText: { fontSize: 10, fontWeight: '600', color: STATUS.success.fg },
  ...
  eventBadgeRemoved: {
    ...
    borderColor: STATUS.neutral.fg,
    borderStyle: 'dashed',
  },
  eventBadgeText: { fontSize: 10, fontWeight: '700' },
  eventBadgeTextApplied: { color: STATUS.info.fg },
  eventBadgeTextRemoved: { color: STATUS.neutral.fg },
  actorName: { fontSize: 11, fontWeight: '600', color: SURFACE_TOKENS.textPrimary },
  actorRole: { fontSize: 10, color: SURFACE_TOKENS.textSecondary },
  footnote: {
    padding: 8,
    fontSize: 10,
    color: SURFACE_TOKENS.textMuted,
