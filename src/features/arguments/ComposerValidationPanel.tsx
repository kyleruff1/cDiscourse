...
const styles = StyleSheet.create({
  ...
  disclaimer: { flex: 1, fontSize: 11, color: SURFACE_TOKENS.textSecondary, fontStyle: 'italic' },
  sourceChip: { fontSize: 10, fontWeight: '700', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  sourceSupabase: { backgroundColor: STATUS.success.bg, color: STATUS.success.fg },
  sourceFallback: { backgroundColor: STATUS.warning.bg, color: STATUS.warning.fg },
  section: { marginBottom: 8 },
  sectionTitleError: { fontSize: 12, fontWeight: '700', color: STATUS.danger.fg, marginBottom: 4 },
  sectionTitleWarn: { fontSize: 12, fontWeight: '700', color: STATUS.warning.fg, marginBottom: 4 },
  ...
  bullet: { fontSize: 12, fontWeight: '700', color: STATUS.danger.fg, width: 14 },
  bulletWarn: { fontSize: 12, fontWeight: '700', color: STATUS.warning.fg, width: 14 },
  errorBody: { flex: 1, gap: 4 },
  warningBody: { flex: 1, gap: 4 },
  errorText: { fontSize: 12, color: STATUS.danger.fg, lineHeight: 16 },
  warningText: { fontSize: 12, color: STATUS.warning.fg, lineHeight: 16 },
  ...
  actionChipText: { fontSize: 11, fontWeight: '700', color: SURFACE_TOKENS.textPrimary },
  topicSection: { paddingTop: 6, borderTopWidth: 1, borderTopColor: SURFACE_TOKENS.border, marginTop: 4 },
  topicHeader: { fontSize: 11, fontWeight: '700', color: SURFACE_TOKENS.textSecondary, textTransform: 'uppercase', letterSpacing: 0.4, marginBottom: 6 },
  topicScoreRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 2 },
  topicLabel: { fontSize: 12, color: SURFACE_TOKENS.textSecondary, fontWeight: '600' },
  topicSubLabel: { fontSize: 11, color: SURFACE_TOKENS.textMuted, paddingLeft: 8 },
  topicValue: { fontSize: 12, fontWeight: '700', color: SURFACE_TOKENS.textPrimary },
  topicSubValue: { fontSize: 11, color: SURFACE_TOKENS.textSecondary },
  topicStatus: { fontWeight: '400', fontSize: 11 },
  topicFailed: { color: STATUS.danger.fg },
  topicWeak: { color: STATUS.warning.fg },
  topicOk: { color: STATUS.success.fg },
  termRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 4, marginTop: 4 },
  termLabelOk: { fontSize: 11, fontWeight: '700', color: STATUS.success.fg },
  termListOk: { fontSize: 11, color: STATUS.success.fg, flex: 1 },
  termLabelMiss: { fontSize: 11, fontWeight: '700', color: STATUS.danger.fg },
  termListMiss: { fontSize: 11, color: STATUS.danger.fg, flex: 1 },
  okRow: { paddingTop: 4 },
  okText: { fontSize: 12, color: STATUS.success.fg, fontWeight: '600' },
  statusChip: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 999 },
  statusChipText: { fontSize: 10, fontWeight: '800', textTransform: 'uppercase' as const, color: SURFACE_TOKENS.textPrimary },
  statusReady: { backgroundColor: STATUS.success.bg },
  statusAdvisory: { backgroundColor: STATUS.warning.bg },
  statusStructural: { backgroundColor: STATUS.danger.bg },
});
