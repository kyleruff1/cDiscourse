...
const styles = StyleSheet.create({
  ...
  // UX-BOARD-READABILITY-001 (2026-06-19): FOR/AGAINST + LATEST pills off the 10px
  // floor (10 -> 11) to align with kindPillText (11). Surface-local micro-type only.
  sidePillText: { color: '#e0e7ff', fontSize: 11, fontWeight: '700' },
  latestPill: { marginLeft: 'auto', backgroundColor: '#0e7490', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 2 },
  latestPillText: { color: '#ecfeff', fontSize: 11, fontWeight: '700', letterSpacing: 0.4 },
  ...
  // UX-BOARD-READABILITY-001 (2026-06-19): standing/qualifier badges + relative
  // timestamp off the 10px floor (10 -> 11; relative now matches timeAbsolute).
  ...
  timeRelative: { color: '#94a3b8', fontSize: 11 },
});
