import type { TopicSatisfactionResult, ConstitutionRule } from './types';
...
/**
 * Extended version that also scores against the parent body.
 * - Root argument: combinedScore = resolutionScore
 * - Reply argument: combinedScore = min(resolutionScore, parentScore)
 * Status is derived from combinedScore.
 */
